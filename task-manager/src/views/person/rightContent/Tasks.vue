<template>
    <div style="width: 50vw; flex:1;">
      ...
      >
        <vxe-column field="name" title="任务名" width="200" show-overflow></vxe-column>
        ...
        <vxe-column field="start_time" title="开始时间" width="120" show-overflow></vxe-column>
        <vxe-column field="deadline_time" title="截止时间" width="120" show-overflow></vxe-column>

<!--        <vxe-column field="workload" title="工作量(天)" width="100"></vxe-column>-->
        <vxe-column field="project" title="项目" width="190" show-overflow></vxe-column>
        ...
        <el-form-item>
          <div style="display: flex; align-items: center;">
            <div style="display: flex; align-items: center; margin-right: 40px; margin-left: 20px;">
              ...
              <el-input-number v-model="feedbackData.act_workload" :step="0.5" :min="0.1"/>
            </div>
            <div style="display: flex; align-items: center;">
...
const handleFeedbackClick = (row) => {
    ...
    //   return
    // }
    feedbackData.value = {id:row.id , name:row.name,content:row.content,challenge:row.challenge, progress: parseInt(row.progress), feedback: row.feedback,act_workload:row.act_workload}
    isOpen.value = true
  }
