<template>
  <div
    style="height:18vh;width: 98%;border: 1px solid #eee;background-color: white;border-radius: 10px;padding: 5px;display: flex;flex-direction: row;justify-content: space-between;">
    <div style="width: 25%;height:15vh;border:1px solid #9e9fa0;border-radius: 10px 0px 0px 10px ;background-color: white;">
      ...
      <div style="display:flex;justify-content: space-around;padding: 10px;">
        ...
        <div style="display:flex;flex-direction:column;justify-content: start;align-items: center;">
          <el-progress type="dashboard" :percentage="curSelectDateStat.per" :stroke-width="15" :width="70" striped-flow />
        </div>
      </div>
    ...
    <el-scrollbar style="width: 45%;height:15vh;border:1px solid #9e9fa0;border-radius: 0px 10px 10px 0px ; background-color: white;">
...
const { curSelectUserInfo, curUserTasksRef, curUserTasksWorkloadsRef, curSelectDateStat } = storeToRefs(scheduleStore)
