<template>
  <div style="width: 50vw;">
    <div style="margin: 10px; text-align:center">
        <el-button class="dispatchTask-el-button" type="primary" @click="dispatchTasks">下发任务</el-button>
        <el-button class="adjustTask-el-button" type="warning" @click="adjustTasks">调整任务</el-button>
    </div>
    <!-- 半屏详情面板 -->
        <el-drawer
